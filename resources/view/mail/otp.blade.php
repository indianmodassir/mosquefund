...
<body>
  <section>
    <strong id="subject">OTP Verification</strong>
    <br/><br/>
    <p><span>OTP: {{$otp}}</span></p>
    <p>is your OTP for Mosque Fund Collection [{{$role}}] verification process. Please do not share this with anyone. Kindly note this is valid for one-time only.</p>
    <p>OTP generated on - <span>{{date('d-m-y h:i:s')}}</span></p>
