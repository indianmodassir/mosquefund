...
<div class="wrap bg" style="background:#fbfbfb;">
  <form action="/final_request" method="post" onsubmit="registration(event)" style="padding:0;">
    <div class="field" style="padding:12px 22px;flex-direction:row;justify-content:flex-end;max-width:100%;gap:6px;flex-wrap:wrap;">
      ...
      <button type="button" data-type="edit" style="width:max-content;padding:0 14px;" data-action="/edit_registration" onclick="sendOptRequest(this)">EDIT</button>
      <button data-action="/admin/dashboard" onclick="window.location.reload()" type="button" style="width:max-content;background:#e54a4a;padding:0 14px;">CLOSE</button>
    </div>
  </form>
</div>