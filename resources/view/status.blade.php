<div id="content" class="tbl-content" style="max-width:1120px;">
    ...
    <form id="paymentForm">
      ...
      <table class="vtable">
        <tr>
          ...
          <td id="profile" rowspan="4">
            <img src="{{$member->profile}}" alt="{{$member->fullname}}" width="100" style="max-height:118px;" draggable="false">
          </td>
        </tr>

        <tr>
          <th style="white-space:nowrap;"><span class="en-label">Member mobile number / </span>सदस्य का मोबाइल नंबर</th>
          <td>{{$member->number}}</td>
        </tr>

        <tr>
          <th style="white-space:nowrap;"><span class="en-label">Gender of Member / </span>सदस्य का लिंग</th>
          <td>{{$member->gender}}</td>
        </tr>

        <tr>
          <th style="white-space:nowrap;"><span class="en-label">Village of Member / </span>सदस्य का गाँव</th>
      ...
      <section style="width:100%; overflow:auto;">
        <table class="vtable tbl-extends">
          <tr style="background:#eef1f5;">
            ...
            <th><span class="en-label">Total / </span>कुल</th>
            <th><span class="en-label">Status / </span>स्थिति</th>
          </tr>
      ...
      <table class="vtable tbl-extends">
        <tr>
          <td class="theader center">Dues Payment Details / बकाया राशि का विवरण</td>
        </tr>
      </table>
      ...
      <table class="vtable tbl-extends">
        <tr>
          <td colspan="7" style="text-align:center; white-space:initial;">
            <span>प्रिय {{$member->fullname}}, आपका इस महीने का कोई बकाया राशि नहीं है। आपने इस महीने का ₹{{$last_payment['paid_amount']}} का भुगतान कर दिया है।</span>
          </td>
        </tr>
      </table>
      @endif
          ...
          <td>
            <div class="flex-box">
              ...
              <button type="button" id="btnPaid" onclick="openConfirmationPopup(this)">
                <i class="fa fa-credit-card"></i>&nbsp;PAID NOW
              </button>
              @endif
  ...
  <script>
    ...
    $('#dueMonth').on('change', () => {
      const dueDate = $('#dueMonth')[0].selectedOptions[0].dataset['date'];
      const selectedIndex = $('#dueMonth')[0].selectedIndex + 1;
      $('#datePreview').text(dueDate);
      $('#duesFee').val(selectedIndex * 100);
      $('#total_dues_months').text(leadZero($('#dueMonth option').length - selectedIndex) + '\x20महीना');
    });
  </script>
